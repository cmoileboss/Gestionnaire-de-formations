namespace NetCoreAPI.Controllers
{
    ...
    public class EvaluationController : ControllerBase
    {
        ...
        public async Task<ActionResult<EvaluationDto>> Create([FromBody] EvaluationDto dto)
        {
            ...
            return CreatedAtAction(nameof(GetById), new { id = created.Value!.EvaluationId }, created.Value);
        }
        ...
        /// <summary>
        /// Récupère tous les utilisateurs inscrits à une évaluation.
        /// </summary>
        /// <param name="id">Identifiant de l'évaluation.</param>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<IEnumerable<UserDto>>> GetEvaluationUsers(int id)
        {
            var result = await _evaluationService.GetEvaluationUsersAsync(id);
            if (!result.IsSuccess)
