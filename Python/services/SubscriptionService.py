...
class SubscriptionService:
    ...
    def get_subscription(self, user_id: int, session_id: int) -> Subscription | None:
        """Retourne un abonnement spécifique, ou None."""
        return self.subscription_repository.get(user_id, session_id)
    ...
    def delete_subscription(self, user_id: int, session_id: int) -> bool:
        """Supprime un abonnement. Retourne True si supprimé."""
